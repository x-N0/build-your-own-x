...
* [**JavaScript**: Writing a Blockchain in Node.js](https://www.jsmonday.dev/articles/34/writing-a-blockchain-in-node-js)
...
* [**JavaScript**: Let's Write a Brainfuck Compiler](https://www.jsmonday.dev/articles/37/let-s-write-a-brainfuck-compiler)
